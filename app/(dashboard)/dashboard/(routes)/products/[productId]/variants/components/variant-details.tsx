...
import { Color, Image, Variant, Size, Spec } from '@/lib/generated/prisma'
...
import { VariantFormSchema } from '@/app/(dashboard)/dashboard/lib/schemas'
import { ImageInput } from '@/app/(dashboard)/dashboard/components/image-color/image-input'
import ClickToAddInputsRHF from '@/app/(dashboard)/dashboard/components/click-to-add'
import InputFieldset from '@/app/(dashboard)/dashboard/components/input-fieldset'
import RichTextEditor from '@/app/(dashboard)/dashboard/components/text-editor/react-text-editor'
import { TagsInput } from '@/app/(dashboard)/dashboard/components/tag-input'
import { DateTimePicker } from '@/app/(dashboard)/dashboard/components/date-time/date-time-picker'
    ...
    <AlertDialog>
      ...
      <Card className="w-full">
        <CardHeader>
          ...
          <CardDescription>
            {variantId
              ? `Update information for ${data?.name || 'the variant'}.`
