...
const defaultValues: AboutUsProps['values'] = [
  ...
  },
  {
    ...
    icon: 'Hop', // پیشنهاد آیکون: یک جوانه یا برگ (نماد پایداری)
  },
]
